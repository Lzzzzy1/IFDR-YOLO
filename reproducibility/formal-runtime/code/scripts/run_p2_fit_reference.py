"""Prepare or run the leakage-free seed-17 plain-P2 reference job."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run the leakage-free fit-only YOLOv8m P2 reference.",
    )
    ...
    parser.add_argument(
        "--execution-purpose",
        choices=(REFERENCE_EXECUTION_PURPOSE, STAGE9_REFERENCE_EXECUTION_PURPOSE, STAGE11_REFERENCE_EXECUTION_PURPOSE, FORMAL_RERUN_REFERENCE_EXECUTION_PURPOSE),
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    print(f"P2 REFERENCE {args.mode.upper()} READY")
