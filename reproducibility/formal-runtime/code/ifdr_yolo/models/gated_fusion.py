...
class ReliabilityGatedConcat(nn.Module):
    def __init__(
        ...
        *,
        ...
        if not isinstance(fusion_modulation, bool):
            raise ValueError("fusion_modulation must be a boolean")
        self.fusion_modulation_enabled = fusion_modulation
    ...
    def set_fusion_modulation(self, value: bool) -> None:
        if not isinstance(value, bool):
            raise ValueError("fusion_modulation must be a boolean")
        self.fusion_modulation_enabled = value
    ...
    def forward(
        ...
        if self.fusion_modulation_enabled:
