...
from ifdr_yolo.experiments.baseline_recovery import recover_baseline_run
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Resume a failed formal baseline/P2 run in place and finish KITTI AP40."
        )
    )
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    print("BASELINE RECOVERY COMPLETE")
